  ...
  def _handle (self, data):
    ...
    try:
      try:
        ...
        #print method #pox.messenger.ajax_transport.AjaxMsgHandler._exec_poll/send function
      except:
        response = {}
      ...
      try:
        #returns JSON-RPC message of Topology
        r = method(*params,**kw)
        #print r
